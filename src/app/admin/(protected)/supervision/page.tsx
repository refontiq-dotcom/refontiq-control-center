...
import { AlertTriangle, Activity, CheckCircle2, Clock3, RefreshCw, ShieldCheck, TrendingDown, TrendingUp } from "lucide-react";
    ...
    <main className="text-slate-900">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 md:px-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-widest text-slate-400"><Activity className="h-4 w-4" /> Supervision Refontiq</div>
            <h1 className="mt-2 text-2xl font-bold tracking-tight">Supervision opérationnelle</h1>
            <p className="mt-1 max-w-2xl text-sm text-slate-500">Analyse déterministe des données reçues : fraîcheur, variations et signaux à surveiller. Aucune estimation n'est présentée comme un fait.</p>
          </div>
